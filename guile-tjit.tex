...
\begin{figure}
  ...
  \small
\begin{verbatim}
0x02cd905b mov    r14,QWORD PTR [rbx]
0x02cd905e mov    r15,QWORD PTR [rbx+0x8]
0x02cd9062 mov    r9,QWORD PTR [rbx+0x18]
0x02cd9066 mov    r8,QWORD PTR [rbx+0x20]
0x02cd906a mov    rcx,QWORD PTR [rbx+0x28]
0x02cd906e mov    rdx,QWORD PTR [rbx+0x30]
0x02cd9072 nop    WORD PTR [rax+rax*1+0x0]
loop:
0x02cd9078 lea    r14,[rdx+0x1]
0x02cd907c mov    r11,QWORD PTR [rcx]
0x02cd907f sar    r11,0x8
0x02cd9083 cmp    rdx,r11
0x02cd9086 jge    0x02ce6028    ->1
0x02cd908c lea    r11,[rdx+0x1]
0x02cd9090 lea    rax,[r11*8+0x0]
0x02cd9098 mov    rdx,QWORD PTR [rax+rcx*1]
0x02cd909c test   rdx,0x2
0x02cd90a3 je     0x02ce6030    ->2
0x02cd90a9 mov    r11,rdx
0x02cd90ac sar    r11,0x2
0x02cd90b0 cmp    r9,r11
0x02cd90b3 jge    0x02ce6030    ->2
0x02cd90b9 add    r15,rdx
0x02cd90bc sub    r15,0x2
0x02cd90c0 cmp    r8,r14
0x02cd90c3 jle    0x02ce6038    ->3
0x02cd90c9 mov    rdx,r14
0x02cd90cc jmp    0x02cd9078    ->loop
0x02cd90d1 nop    DWORD PTR [rax+0x0]
\end{verbatim}
\caption{Native code of compiled trace under x86-64 architecture.}
\label{fig:ncode}
\end{figure}
