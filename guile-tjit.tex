...
\begin{table}
  ...
  \begin{tabular}{ccl}
    ...
    \#\textbackslash c \ldots \\ % \hline
    \texttt{XXXXXX1100000100} & empty list & `() \\ % \hline
...
Guile's bytecode compiler is designed as \textit{compiler
  tower}\cite{guileref}. The compiler consists from several compilers defining
tower of languages. Each step of the compilation sequence knows how to compile
down to the step below, until the compiled output turns into bytecode
instruction set executed by the VM.\@
...
%% \textit{This section describes overview of the Nash architecture. Mention
%%   tracing done in VM-regular, assembler backend, ... etc.}
...
%% Maybe add nested tight loop program, compare with C, Lua, Python, and
%% JavaScript:
%%
%% (define (loop)
%%   (let lp1 ((i1 0) (counter 0))
%%     (if (< i1 10)
%%         (let lp2 ((i2 0) (counter counter))
%%           (if (< i2 32000)
%%               (let lp3 ((i3 0) (counter counter))
%%                 (if (< i3 32000)
%%                     (lp3 (+ i3 1)
...
%% \acks{} Nash never existed without hard works done for development of GNU
%% Guile, and pioneered works in tracing JIT field.
...
\bibitem{shinn2011chibi} A.~Shinn.  \newblock{}Chibi-scheme-small footprint
  scheme for use as a c extension language \newblock{\em URL
    https://github.com/ashinn/chibi-scheme}

\bibitem{souflis2012tinyscheme} D.~Souflis and J.~Shapiro.  \newblock
  Tinyscheme.  \newblock{\em URL http://tinyscheme.sourceforge.net}

\bibitem{fujita2008ypsilon} Y.~Fujita.  \newblock Ypsilon Scheme. \newblock
  {\em URL http://www.littlewingpinball.net/mediawiki/index.php/Ypsilon}

\bibitem{kawai2001gauche} S.~Kawai. \newblock Gauche \newblock {\em URL
  http://practical-scheme.net/gauche}

\bibitem{serrano1995bigloo}
...
\bibitem{dybvigchez} K.~Dybvig. \newblock Chez Scheme
  \newblock {\em URL http://scheme.com}

\bibitem{feeleygambit} M.~Feeley. \newblock Gambit Scheme
  \newblock {\em URL http://gambitscheme.org/wiki/index.php/Main\_Page}

\bibitem{hansenlarceny} Hansen et~al. \newblock Larceny
  \newblock {\em URL http://larcenists.org}

\bibitem[Bauman et~al.(2015)Bauman, Spenser]{bauman2015pycket} S.~Bauman,
...
\bibitem{gnuguile} \newblock GNU Guile
  \newblock {\em URL http://www.gnu.org/software/guile/}

\bibitem{abelson1998revised5}
...
\newblock {\em Higher-order and symbolic computation}, 11(1):7--105, 1998.

\bibitem{sperber2010revised} M.~Sperber, R.~K. Dybvig, and M.~Flatt.
  \newblock {\em Revised [6] report on the algorithmic language Scheme},
  volume~19.  \newblock Cambridge University Press, 2010.

\bibitem{guileref} Guile Reference Manual \newblock
  {\em URL https://www.gnu.org/software/guile/manual/html\_node/index.html}

\bibitem{pall2008luajit} M.~Pall.  \newblock The luajit project.  \newblock
  {\em Web site: http://luajit.org}, 2008.

\bibitem{baldridge2014pixie} T.~Baldridge.  \newblock Pixie \newblock {\em Web
  site: http://pixielang.org}, 2014

\bibitem{gal2009trace}
...
\newblock {\em ACM Sigplan Notices}, 44(6):465--478, 2009.

\bibitem{bala2000dynamo}
...
\bibitem{gdbdebugger}
  ...
  \newblock {\em URL: http://www.gnu.org/software/gdb/}
...
\bibitem{gnulightning}
  \newblock GNU lightning
  \newblock {\em URL: https://www.gnu.org/software/lightning/}

\bibitem{pall2009ip}
  \newblock LuaJIT 2.0 intellectual property disclosure and research
  opportunities
  \newblock {\em URL: http://lua-users.org/lists/lua-l/2009-11/msg00089.html}

\bibitem{value2011wingo}
