...
\preprintfooter{DRAFT: Nash, a tracing JIT VM for GNU Guile}
...
\begin{table}
  ...
  \begin{tabular}{|c|c|l|} \hline
    ...
    \texttt{xxxxxxxxxxxxx000} & heap object & 'foo, \#(1 2 3) ... \\ % \hline
    \texttt{xxxxxxxxxxxxxx10} & small integer & 1, 2, 3, 4, 5 ... \\ % \hline
    \texttt{xxxxxxxxxxxxx100} & boolean false & \#f \\ % \hline
    \texttt{xxxxxxxx00001100} & character & \#\textbackslash a, \#\textbackslash b,
    \#\textbackslash c ... \\ % \hline
...
%%  LocalWords:  typedef Immediates immediates LuaJIT Pypy Lua Rpython
%%  LocalWords:  RPython
